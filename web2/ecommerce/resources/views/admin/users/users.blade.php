                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                <input class="form-control w-50" minlength="6" id="passwordval-{{ $user['id'] }}" value=""  style="background-color: #e9e9e9">                                                
                                                <a class="resetUserPassword" id="userpassword-{{ $user['id'] }}" userpassword_id="{{ $user['id'] }}" passwordval_id = "passwordval-{{ $user['id'] }}" href="javascript:void(0)"> {{-- Using HTML Custom Attributes. Check admin/js/custom.js --}}
