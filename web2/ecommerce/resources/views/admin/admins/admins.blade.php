                                    ...
                                    <tbody>
                                        @foreach ($admins as $admin)
                                            <tr>
                                                ...
                                                <!-- Adding the password reset option -->
                                                <td>
                                                <input class="form-control w-50" minlength="6" id="passwordval-{{ $admin['id'] }}" value=""  style="background-color: #e9e9e9">                                                
                                                <a class="resetAdminPassword" id="adminpassword-{{ $admin['id'] }}" adminpassword_id="{{ $admin['id'] }}" passwordval_id = "passwordval-{{ $admin['id'] }}" href="javascript:void(0)"> {{-- Using HTML Custom Attributes. Check admin/js/custom.js --}}
                                                <i style="font-size: 25px" class="mdi mdi-key"></i> {{-- Icons from Skydash Admin Panel Template --}}
                                                </a>
                                                </td>
                                                <!-- Adding the password reset option -->
                                            </tr>
